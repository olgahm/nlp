...
public class IXAAnnotatorDE implements IXAAnnotator{

    private static final Logger LOG = LoggerFactory.getLogger(IXAAnnotatorDE.class);
    ...
    public IXAAnnotatorDE(String resourceFolder) {
        model              = Paths.get(resourceFolder,"morph-models-"+ IXAService.kafVersion+"/de/de-pos-perceptron-autodict01-conll09.bin").toFile().getAbsolutePath();
        lemmatizerModel    = Paths.get(resourceFolder,"morph-models-"+ IXAService.kafVersion+"/de/de-lemma-perceptron-conll09.bin").toFile().getAbsolutePath();
        language           = "de";
